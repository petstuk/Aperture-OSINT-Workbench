...
2. Package for store upload: `./package-for-firefox.sh` → `aperture-osint-v3.1.1.zip`
...
Release notes: [`RELEASE_NOTES_v3.1.1.md`](RELEASE_NOTES_v3.1.1.md) · [`v3.1.0`](RELEASE_NOTES_v3.1.0.md) · [`v3.0.1`](RELEASE_NOTES_v3.0.1.md) · [`v3.0.0`](RELEASE_NOTES_v3.0.0.md)
